...
* **Configuration** – this allows setup/update of the mailbox settings
  * _Mailbox_ – shows the email address for the organisation and is automatically created upon organisation creation with a standard naming convention of \<organisation name>@mail.utilibox.tech
  * _Change Mailbox Name_ – this is only available for organisations with suffixes on their names that can be removed from the email address (eg. “incorporated", " inc", " proprietary", " pty", " limited", " ltd")
  * _+ Add Forwarding Route_
